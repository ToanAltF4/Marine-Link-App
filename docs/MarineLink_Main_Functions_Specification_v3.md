...
Ứng dụng hiển thị sản phẩm theo danh mục hoặc theo kết quả tìm kiếm.

Mỗi sản phẩm hiển thị hình ảnh, tên sản phẩm, xuất xứ, giá, số lượng đặt tối thiểu và trạng thái còn hàng.

Người dùng lọc theo danh mục, khoảng giá, trạng thái còn hàng hoặc sắp xếp theo giá.
...
| Product State | Quản lý danh sách sản phẩm, chi tiết sản phẩm, tìm kiếm, lọc và trạng thái tải dữ liệu. |
